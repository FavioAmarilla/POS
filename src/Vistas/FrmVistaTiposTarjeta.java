...
public class FrmVistaTiposTarjeta extends javax.swing.JDialog {

   
    ContTcCobrosCaja voucher = new ContTcCobrosCaja();
    DefaultTableModel modelo = new DefaultTableModel();

    public FrmVistaTiposTarjeta() {
        initComponents();
        setModal(true);
    ...
    private void mandarDatos(int id, String desc) {
        FrmPosCobros.idTipoTarjeta = id;
        FrmPosCobros.txtTipoTarjeta.setText(desc);
        FrmPosCobros.txtCuotas.requestFocus();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmVistaTiposTarjeta().setVisible(true);
            }
        });
    }
